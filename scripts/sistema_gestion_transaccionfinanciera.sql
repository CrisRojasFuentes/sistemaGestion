...
--
-- Table structure for table `transaccionfinanciera`
--

DROP TABLE IF EXISTS `transaccionfinanciera`;
...
--
-- Dumping data for table `transaccionfinanciera`
--

LOCK TABLES `transaccionfinanciera` WRITE;
/*!40000 ALTER TABLE `transaccionfinanciera` DISABLE KEYS */;
/*!40000 ALTER TABLE `transaccionfinanciera` ENABLE KEYS */;
UNLOCK TABLES;
