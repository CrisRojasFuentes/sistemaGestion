...
CREATE TABLE `detalles_venta` (
  ...
  `total_detalle` decimal(38,2) NOT NULL,
  `id_ventas` int DEFAULT NULL,
  PRIMARY KEY (`id_detalle`),
  KEY `FKkjfngeq4lktx0kji13qwthihk` (`id_producto`),
  CONSTRAINT `FKkjfngeq4lktx0kji13qwthihk` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`)
...
INSERT INTO `detalles_venta` VALUES (1,1,1,800.00,1),(5,1,1,800.00,1);
